The Project RESUME has been made using React, CSS, React-Bootstrap, React hooks, React Router.

1) There are two components A & B respectively.

2) In A Components there are Navbar links and their files.
